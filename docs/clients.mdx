...
| [BoltAI][BoltAI]                            | ❌          | ❌        | ✅      | ❌         | ❌    | Supports tools in BoltAI                                                    |
...
### BoltAI
[BoltAI](https://boltai.com/docs/plugins/mcp-servers) is an all-in-one AI chat client for Mac with built-in MCP support. It's native, fast and versatile.
